...
| [19.1](../SPEC.md#191-面白さの定義と判定基準) | 面白さの定義と判定基準（F-1〜F-12） | プレイテストの合否判断基準。[playtest-findings.md](./playtest-findings.md) | 🟡 定義済み。F-1・F-2・F-4・F-5・F-6・F-7・F-8・F-10・F-11・F-12 が未充足でRI-72〜87。F-9 は**部分検証**（進行速度と決着位置のみ成立。「打てた手」の差は未計測でRI-88）。F-3 は未検証 |
...
| 難易度カーブと、常に正解／常に不正解な手がある | 第16／第19.1 F-1・F-7 | [RI-72](./remaining-issues.md#ri-72-難易度カーブと常に正解常に不正解な手がある構造) |
...
| カードが集中力だけを消費し、勝率を動かさない | 第7／第19.1 F-2・F-4 | [RI-77](./remaining-issues.md#ri-77-カードが集中力だけを消費し勝率を動かさない) |
...
| Q1 で進化ツリーを取り切れ、ビルドの方向という概念が成立しない | 第11／第19.1 F-11 | [RI-85](./remaining-issues.md#ri-85-q1-で進化ツリーを取り切れてしまいビルドの方向という概念が成立しない) |
...
| 敗因ごとに「打てた手」が違うかを測る手段が無い（F-9 が部分検証に留まる） | 第19.1 F-9 | [RI-88](./remaining-issues.md#ri-88-敗因ごとに打てた手が違うかを測る手段が無い) |

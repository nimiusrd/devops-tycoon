...
export const TUTORIAL_STEPS: readonly TutorialStep[] = [
  {
    ...
    title: '介入バー',
    body: 'マネジメント集中力を使って現場へ介入します。燃え尽きを防ぐ最大の一手は緊急対応（炎上を自動鎮火の前に消す）です。アンドンは既存キューを捌く猶予、AIスロットルは点火率と手戻り率を下げ、品質・PR分割は手戻り率だけを下げます。ペアレビューは詰まったPRを処理しつつAI Literacyを上げ、依存度が高くてもリテラシーが低いままだと敗北するので早めに使いましょう。編成の review 増員はスループット策であり、燃え尽き回避の主手段ではありません。',
  },
  {
    id: 'senior-hp',

...
2026-07-18 の棚卸しで RI-01〜RI-57 の主要残務は完了し、通しテスト DoD（RI-40: unit 771 件・E2E 40 件・lint / format / build）も緑を確認した。残るのは保留(要判断)の RI-24 / RI-28 / RI-34 と、新規に洗い出した **RI-58（ラン途中セーブと復帰）・RI-59（サウンド演出）・RI-60（初見向けオンボーディング）・RI-61（リプレイ保存、保留）**。次の柱は「1 ランの体験を外側から支える基盤（中断復帰・導入導線・音）」で、詳細は [remaining-issues.md](./remaining-issues.md) を参照。

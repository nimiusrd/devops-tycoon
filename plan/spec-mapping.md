...
| [19.1](../SPEC.md#191-面白さの定義と判定基準) | 面白さの定義と判定基準（F-1〜F-12） | プレイテストの合否判断基準。[playtest-findings.md](./playtest-findings.md) | 🟡 定義済み。F-1・F-2・F-4・F-5・F-6・F-7・F-8・F-10・F-12 が未充足でRI-72〜84。F-9・F-11 は成立。F-3 は未検証 |
...
| 難易度カーブと、単一介入が複合方針を上回る | 第16／第19.1 F-1・F-7 | [RI-72](./remaining-issues.md#ri-72-難易度カーブと単一介入が複合方針を上回る構造) |
...
| 敗北の大半がスプリント間フェーズで確定する | 第4／第19.1 F-4・F-8 | [RI-84](./remaining-issues.md#ri-84-敗北の大半がスプリント間フェーズで確定する) |

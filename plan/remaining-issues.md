...
| RI-61 | リプレイ保存・閲覧 | 低 | 完了 | RI-58 | 第22 / 23 |
...
| RI-34‴ | カードデッキカスタマイズ（研修方針 / §23 切片） | 中 | 完了 | — | 第23 / 7 / 17 |
...
#### RI-61 リプレイ保存・閲覧 — 優先度:低 / 完了（依存: RI-58）
...
残る候補: 社内LT/経営プレゼンモード、ツール別シナリオ、組織シナリオ共有、
組織診断ダッシュボード深掘り、四半期レビュー高度化、「レビュー地獄リプレイ」（RI-61 依存）等。
着手時に個別 ID へ切り出す。
「なぜ燃えたか」は RI-34′、「AI導入失敗図鑑」は RI-34″、
「カードデッキカスタマイズ（研修方針）」は RI-34‴ として切り出し済み。
...
#### RI-34‴ カードデッキカスタマイズ（研修方針） — 優先度:中 / 完了

**完了**: ラン外の「研修方針」画面で優先施策を最大 2 枚選べる。選択は

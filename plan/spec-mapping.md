...
| 課題 | 影響 | 追跡先 |
| --- | --- | --- |
| バランスパラメータSSoTのデイリーへのルールセット伝播 | 第21／第22.3／第22.5 | [RI-104](./remaining-issues.md#ri-104-バランスパラメータssotの導入)／[RI-121](./remaining-issues.md#ri-121-デイリー診断情報へのルールセット伝播) |

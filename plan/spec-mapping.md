...
| 課題 | 影響 | 追跡先 |
| --- | --- | --- |
| バランスパラメータSSoTの残領域移行、コンテンツカタログ、代表曲線、ルールセット永続化 | 第21／第22.3／第22.5 | [RI-104](./remaining-issues.md#ri-104-バランスパラメータssotの導入) |

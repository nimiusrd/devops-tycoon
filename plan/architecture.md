...
| 盤面描画 | DOM/SVG（MVP1〜3）→ PixiJS + pixi-viewport（MVP4/5着手前ゲート） | タスク粒・アイソメ盤面・フロー・ヒートマップ・延焼 |
...
- MVP4/5 着手前ゲート: 粒数/ズーム階層が増える時点で PixiJS へ移植。React/TS/Framer Motion/Recharts は役割を限定して継続。

...
| 予算枯渇・信頼枯渇が予兆なく終わり、敗因ラベルが実態と一致しない | 第15／第19.1 F-6・F-8 | [RI-79](./remaining-issues.md#ri-79-予算枯渇信頼枯渇が予兆なく終わり敗因ラベルが実態と一致しない) |
...
| 敗北画面に「次の一手」が無い | 第13／第19.1 F-6 | [RI-82](./remaining-issues.md#ri-82-敗北画面に次の一手が無い) |

...
export function ManagerPortrait() {
  return (
    ...
    >
      ...
      <circle cx="50" cy="46" r="24" fill={VISUAL_TOKENS.colors.actor.skin} />
      <path d="M27 44 q1 -24 23 -24 q22 0 23 22 q-11 -9 -23 -9 q-12 0 -23 11z" fill="#2f2238" />
      <circle cx="42" cy="46" r="3" fill={VISUAL_TOKENS.colors.ink} />
      <circle cx="58" cy="46" r="3" fill={VISUAL_TOKENS.colors.ink} />
      <path
        d="M41 56 q9 6 18 0"
        stroke="#9a5a4a"
        strokeWidth="2.4"

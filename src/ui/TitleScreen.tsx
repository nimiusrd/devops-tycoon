  ...
  return (
    <div className="title-screen" data-testid="title">
      ...
      <div className="title-content">
        ...
        <section className="title-section title-panel">
        ...
        {onStartDaily && (
          <section className="title-section title-panel" data-testid="daily-run-section">
        ...
        <div className="title-actions title-launch-row">
          <button
            type="button"

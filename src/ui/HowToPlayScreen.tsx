...
const SECTIONS: readonly { title: string; body: string }[] = [
  ...
  {
    title: 'スプリント中の介入',
    body: '画面下の介入バーから、マネジメント集中力を使って現場へ手を入れます。緊急対応は複数炎上や延焼直前だけが本命で、余裕のある先消しはかえって高くつきます。アンドンはキューを捌く猶予、AIスロットルは新規タスクをAIなしにします。ワークフローが未熟なら点火・手戻りを抑えますが、前提度が高く成熟しているときは工程ずれで手戻りが増えることがあります。ペアレビューは詰まったPRを処理しつつAI Literacyを上げ、依存度が高くてもリテラシーが低いままだと敗北するので早めに使いましょう。一部の介入は武装してから盤面へドラッグします。',
  },
  {
    title: 'シニア体力と燃え尽き',

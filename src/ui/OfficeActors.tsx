...
function Desk({ tone = 'wood' }: { tone?: 'wood' | 'dark' }) {
  ...
  return (
    <g>
      ...
      <rect x="38" y="150" width="3.2" height="34" fill={desk.leg} />
      <rect x="178" y="150" width="3.2" height="34" fill={desk.leg} />
      <rect x="108" y="185" width="3.2" height="34" fill={desk.leg} />
    </g>
  );
}
    ...
    return (
      <>
        ...
        <ellipse
          ...
          rx="2.5"
          ry="3.5"
          fill={VISUAL_TOKENS.colors.aiBot.eye}
          opacity=".85"
        />
      </>
    );

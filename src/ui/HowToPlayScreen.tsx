...
const SECTIONS: readonly { title: string; body: string }[] = [
  ...
  {
    title: 'スプリント中の介入',
    body: '画面下の介入バーから、マネジメント集中力を使って現場へ手を入れます。燃え尽きを防ぐ最大の一手は緊急対応です。アンドンはキューを捌く猶予、AIスロットルは点火率と手戻り率を下げます。一部の介入は武装してから盤面へドラッグします。',
  },
  {
    title: 'シニア体力と燃え尽き',
    body: 'シニア体力はメンバー個別のスタミナとは別の抽象値です。尽きるとシニア燃え尽きで敗北します。炎上の自動鎮火は大きく削るので、その前に緊急対応で消し、アンドンやAIスロットルで流入を抑えてから休息で戻しましょう。',
  },
  {
    title: 'レビュー渋滞を見る',

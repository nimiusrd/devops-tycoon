...
| [19.1](../SPEC.md#191-面白さの定義と判定基準) | 面白さの定義と判定基準（F-1〜F-12） | プレイテストの合否判断基準。[playtest-findings.md](./playtest-findings.md) | 🟡 定義済み。F-1・F-2・F-4・F-5・F-7・F-8・F-10・F-11・F-12 が未充足でRI-73〜87。F-6 は RI-82、F-9 の「打てた手」観測は RI-89 で計測可能。F-3 は未検証 |

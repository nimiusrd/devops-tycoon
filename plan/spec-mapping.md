...
| 課題 | 影響 | 追跡先 |
| --- | --- | --- |
| バランスパラメータSSoTの代表曲線、リプレイ・デイリーへのルールセット伝播 | 第21／第22.3／第22.5 | [RI-104](./remaining-issues.md#ri-104-バランスパラメータssotの導入) |

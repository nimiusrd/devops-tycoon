 ...
 *
 * RI-86 / F-11: 入手速度は据え置き、ノードコストを上げて希少性を作る。
 * Q1 中央値帯（旧実測 p50≈44）ではツリー総コストに届かず、1〜2 ブランチへ寄せる選択になる。
 * ティア目安: 起点 1 / 中段はブランチにより 3〜4 / ペーシング先端（dev・review）7 / その他先端 20〜24。総コスト 101。
 * 起点〜中段は早く取れ（F-4 / 方向づけ）、先端の重さで Q1 全解放を防ぐ。
 */

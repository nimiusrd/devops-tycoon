...
| [4.1〜4.6](../SPEC.md#4-ゲーム画面) | 現場、HUD、介入、ビート、進化、リザルト | `src/ui/*Screen.tsx`, `src/ui/SprintLayout.tsx`, `src/ui/AspectStage.tsx`, `src/sim/actions.ts`, `src/render/boardScene.ts`, `tests/e2e/sprint-layout.spec.ts`, `tests/e2e/sprint-pixi-visual.spec.ts` | 🟡 主要機能、RI-69／RI-70の個別症状、RI-94の5 viewport契約、RI-95の名前付きスロット、RI-96のスプリント盤面共通AspectStageを固定済み。CSS／トークンの構造的解消はRI-97〜99 |

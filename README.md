...
コアループは通しプレイ可能です。F-9 敗因別手触りの定性検証（RI-139）まで完了し、
現在の未充足・保留課題はありません。検証結果は[プレイテスト所見](plan/playtest-findings.md)、
完了項目は[残課題バックログ](plan/remaining-issues.md)を参照してください。

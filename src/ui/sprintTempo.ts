...
/**
 * 1x 再生時の実時間/tick（ms）。
 * 現状 tick 分布の中央を §3.1 帯へ寄せる（代表 seed の p50 ≒ 60 秒台）。
 */
export const MS_PER_TICK_1X = 680;
 ...
 * プレイヤー任意（目安 30〜60）のため、回帰検知では帯内の標準操作 40 秒を固定加算する。
 */
export const BETWEEN_SPRINT_WALL_SEC = 40;

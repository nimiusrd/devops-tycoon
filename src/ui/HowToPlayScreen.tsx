...
const SECTIONS: readonly { title: string; body: string }[] = [
  ...
  {
    title: 'スプリント中の介入',
    body: '画面下の介入バーから、マネジメント集中力を使って現場へ手を入れます。燃え尽きを防ぐ最大の一手は緊急対応です。アンドンはキューを捌く猶予、AIスロットルは点火率と手戻り率を下げます。ペアレビューは詰まったPRを処理しつつAI Literacyを上げ、依存度が高くてもリテラシーが低いままだと敗北するので早めに使いましょう。一部の介入は武装してから盤面へドラッグします。',
  },
  {
    title: 'シニア体力と燃え尽き',

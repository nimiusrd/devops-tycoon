...
export const TUTORIAL_STEPS: readonly TutorialStep[] = [
  {
    ...
    title: '介入バー',
    body: 'マネジメント集中力を使って現場へ介入します。緊急対応は複数炎上や延焼直前（タイマーが短いとき）だけが本命で、余裕のある先消しは高コストです。アンドンは既存キューを捌く猶予、AIスロットルは点火率と手戻り率を下げ、品質・PR分割は手戻り率だけを下げます。ペアレビューは詰まったPRを処理しつつAI Literacyを上げ、依存度が高くてもリテラシーが低いままだと敗北するので早めに使いましょう。編成で review や稼働人数を増やすと、レビュー単価とシニア消耗が薄まり燃え尽きにくくなります。',
  },
  {
    id: 'senior-hp',

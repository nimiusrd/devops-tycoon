...
| [19.1](../SPEC.md#191-面白さの定義と判定基準) | 面白さの定義と判定基準（F-1〜F-12） | プレイテストの合否判断基準。[playtest-findings.md](./playtest-findings.md) | 🟡 定義済み。F-1・F-2・F-4・F-5・F-7・F-8・F-10・F-11 が未充足でRI-73〜87。F-6 は RI-82 で敗北画面の次の一手を実装済み。F-12 は RI-81 でドラフトマリガンを実装済み。F-9 は**部分検証**（進行速度と決着位置のみ成立。「打てた手」の差は未計測でRI-89）。F-3 は未検証 |
